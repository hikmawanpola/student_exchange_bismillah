...
import { Users, BarChart3, LogOut, Menu, X, Home, CheckSquare, AlertCircle } from "lucide-react"

const navigation = [
  { name: "Dashboard", href: "/admin", icon: Home },
  { name: "Review Aplikasi", href: "/admin/reviews", icon: AlertCircle },
  { name: "Kelola Mahasiswa", href: "/admin/students", icon: Users },
  { name: "Progress Monitor", href: "/admin/progress", icon: CheckSquare },
      ...
      <div className={cn("fixed inset-0 z-50 lg:hidden", sidebarOpen ? "block" : "hidden")}>
        ...
        <div className="fixed left-0 top-0 h-full w-64 bg-card border-r">
          <div className="flex h-16 items-center justify-between px-4 border-b">
            <span className="text-lg font-semibold">Admin Prodi</span>
